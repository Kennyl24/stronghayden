...
class SearchBar extends React.Component { 
  ...
  render () {
    ...
    return (
  <div style={{zIndex:'999', position:'fixed', bottom: isMobile ? '0px' : '20px', borderRadius:'8px', textAlign:'center', backgroundColor:'rgba(255, 255, 255, 0.6)', marginTop: '10px', marginBottom:'10px', border: '1px solid green', width: isMobile ? '90%':'80%', marginLeft:isMobile ? '5%' : '10%', display:'flex', flexDirection:'row', flexWrap:'wrap'}}>
