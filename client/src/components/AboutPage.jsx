...
class AboutPage extends React.Component { 
  ...
  render () {
    return (
      ...
      {/* <TeamExperience/> */}
      <AboutUs/>
      <div style={{height:'250px', backgroundColor:'#eee', color:'black'}}> 
      ...
      <div className="home-background" style={{position:'relative', top: isMobile ? '120px':'00px',backgroundColor: 'rgba(238, 238, 238, 0.41) !important', backgroundImage: `url(${aboutsec})`, backgroundRepeat: 'no-repeat', imageRendering: '-webkit-optimize-contrast', backgroundSize:isMobile ? 'contain':'cover', height: isMobile ? '350px' : '350px', width: '100%', marginBottom:'0px'}}>
      <div className="scrim2">
      <p className= {isMobile ? 'about-us-mobile2' :"about-us2"}>
