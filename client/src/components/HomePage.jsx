...
<video id="background-video" style={{height: isMobile ? '300px' : '100%', minHeight: isMobile ? '300px' : '100%', top: isMobile ? '100px' : '0px'}}defaultMuted playsinline loop autoPlay muted>
